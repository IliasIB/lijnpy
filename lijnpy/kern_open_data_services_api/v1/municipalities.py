...
from lijnpy.kern_open_data_services_api.v1.models import Line, Municipality, Stop
...
def get_municipalities() -> list[Municipality]:
    ...
    Returns:
        Municipalities: A list of all municipalities in Belgium
    """
...
def get_stops(municipality_number: int) -> list[Stop]:
    ...
    Returns:
        Stops: A list of stops in the municipality
    """
...
def get_lines(municipality_number: int) -> list[Line]:
    ...
    Returns:
        Lines: A list of lines in the municipality
    """
