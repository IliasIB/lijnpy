...
from lijnpy.kods.v1.entities import (
    get_entities,
    get_entity,
    get_lines,
    get_municipality,
...
@mock.patch(
    "requests.request",
    return_value=input_as_response("tests/kods/v1/inputs/entiteiten.json"),
)
def test_entities(_):
...
@mock.patch(
    "requests.request",
    return_value=input_as_response("tests/kods/v1/inputs/entiteit.json"),
)
def test_entity(_):
